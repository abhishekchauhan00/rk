...
<head>
    ...
    <title>Principal's Message | RK International School</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <h1>Principal's Message to Parents</h1>
            <ul class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">Principal's Message to Parents</li>
            </ul>
        </div>
    </div>
    ...
    <iframe width="420" height="315" src="https://www.youtube.com/embed/tgbNymZ7vqY" frameborder="0" allowfullscreen></iframe>
                ...
                <br><br><h3 class="heading">Dear <span class="color2">Parents</span></h3>
                <blockquote>
